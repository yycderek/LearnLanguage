...
function baseCourse({
  ...
  return {
    ...
    manifest: {
      ...
      description: l("从文字或标音基础开始，逐步学习核心表达并迁移到咖啡店点单场景。", "Start with the writing or romanization system, build essential expressions, and transfer them into a café-ordering scenario."),
